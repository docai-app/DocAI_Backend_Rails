...
ActiveRecord::Schema[7.0].define(version: 2026_04_02_120000) do
  ...
  create_table "communities", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["code"], name: "index_communities_on_code", unique: true
    t.index ["general_user_id"], name: "index_communities_on_general_user_id"
    t.index ["general_user_id"], name: "index_communities_on_general_user_id"
  end
  ...
  create_table "community_memberships", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["community_id", "general_user_id"], name: "index_community_memberships_on_community_and_user", unique: true
    t.index ["community_id", "general_user_id"], name: "index_community_memberships_on_community_and_user", unique: true
    t.index ["community_id"], name: "index_community_memberships_on_community_id"
    t.index ["community_id"], name: "index_community_memberships_on_community_id"
    t.index ["general_user_id"], name: "index_community_memberships_on_general_user_id"
    t.index ["general_user_id"], name: "index_community_memberships_on_general_user_id"
  end
  ...
  add_foreign_key "assignment_distributions", "public.essay_assignments", column: "essay_assignment_id"
  add_foreign_key "assignment_distributions", "public.general_users", column: "target_student_id"
  add_foreign_key "assignment_distributions", "public.school_academic_years", column: "school_academic_year_id"
  add_foreign_key "assignment_distributions", "public.schools", column: "school_id"
  ...
  add_foreign_key "assignment_reminders", "public.essay_assignments", column: "essay_assignment_id"
  add_foreign_key "assignment_reminders", "public.general_users", column: "general_user_id"
  add_foreign_key "assignment_reminders", "public.general_users", column: "reminder_sender_id"
  add_foreign_key "assignment_reminders", "essay_assignments"
  add_foreign_key "assignment_reminders", "general_users"
  add_foreign_key "assignment_reminders", "general_users", column: "reminder_sender_id"
  add_foreign_key "assignment_reminders", "public.essay_assignments", column: "essay_assignment_id"
  ...
  add_foreign_key "assignment_student_assignments", "public.assignment_distributions", column: "assignment_distribution_id"
  add_foreign_key "assignment_student_assignments", "public.essay_assignments", column: "essay_assignment_id"
  add_foreign_key "assignment_student_assignments", "public.general_users", column: "general_user_id"
  add_foreign_key "assignment_student_assignments", "assignment_distributions"
  add_foreign_key "assignment_student_assignments", "essay_assignments"
  add_foreign_key "assignment_student_assignments", "general_users"
  add_foreign_key "assignment_student_assignments", "public.assignment_distributions", column: "assignment_distribution_id"
  ...
  add_foreign_key "communities", "public.general_users", column: "general_user_id"
  add_foreign_key "communities", "general_users"
  add_foreign_key "communities", "public.general_users", column: "general_user_id"
  add_foreign_key "community_memberships", "communities"
  add_foreign_key "community_memberships", "general_users"
  add_foreign_key "community_memberships", "public.communities", column: "community_id"
  add_foreign_key "community_memberships", "public.general_users", column: "general_user_id"
  add_foreign_key "community_memberships", "communities"
  add_foreign_key "community_memberships", "general_users"
  add_foreign_key "community_memberships", "public.communities", column: "community_id"
  add_foreign_key "community_memberships", "public.general_users", column: "general_user_id"
  ...
  add_foreign_key "essay_assignments", "public.communities", column: "community_id"
  add_foreign_key "essay_assignments", "communities"
  add_foreign_key "essay_assignments", "public.communities", column: "community_id"
  ...
  add_foreign_key "supplement_practice_records", "public.essay_assignments", column: "essay_assignment_id"
  add_foreign_key "supplement_practice_records", "public.essay_gradings", column: "essay_grading_id"
  add_foreign_key "supplement_practice_records", "public.general_users", column: "general_user_id"
  add_foreign_key "supplement_practice_records", "essay_assignments"
  add_foreign_key "supplement_practice_records", "essay_gradings"
  add_foreign_key "supplement_practice_records", "general_users"
  add_foreign_key "supplement_practice_records", "public.essay_assignments", column: "essay_assignment_id"
