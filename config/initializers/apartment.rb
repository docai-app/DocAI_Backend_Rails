...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w[ApiKey AssistantAgent SuperAdmin AgentUseTool AgentTool]
  ...
  # config.tenant_names = %w[public chyb-dev chyb wishcoffee-dev wishcoffee docai-dev docai]
