...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w[ApiKey AssistantAgent SuperAdmin AgentUseTool AgentTool Entity Cors GeneralUser Energy
                              EnergyConsumptionRecord MarketplaceItem Purchase UserMarketplaceItem]
